...
--- error_code: 401
--- error_log
auth_jwt: failed requirement for "roles":  "["admin","service"]" is not "intersect" "["user_role1" , "user_role2", "user_role3"]"
...
--- error_code: 401
--- error_log
auth_jwt: failed requirement for "roles":  "["admin","service"]" is not "intersect" ""just string""
...
--- error_code: 401
--- error_log
auth_jwt: failed requirement for "name":  ""John Doe"" is not "intersect" "["user_role1" , "user_role2", "user_role3"]"